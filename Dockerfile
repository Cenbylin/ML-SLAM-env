...
# common
RUN apt-get -y install cmake libpython2.7-dev 
...
RUN conda install -y -c https://mirrors.ustc.edu.cn/anaconda/cloud/pytorch pytorch torchvision cpuonly 
...
ADD CoppeliaSim_Edu_V4_0_0_Ubuntu18_04.tar /opt 
ADD PyRep.tar /opt

# install pyrep. 
# env variables here may affect the compilation of orbslam2.
ENV COPPELIASIM_ROOT=/opt/CoppeliaSim_Edu_V4_0_0_Ubuntu18_04
